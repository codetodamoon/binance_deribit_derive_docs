# Standard Margin Parameters [SOL/HYPE Added]
...
| :-------------------- | :--------------------------------- | :----- | :---- | :---- | :--- | :----------- | :------------------------------------------------------------------------------------------------------- |
| `BASE_DISCOUNT`       | `baseMargin.marginFactor`          | 0.8    | 0.75  | NA    | 0.55 | \[0.0, 0.99] | Discount to the collateral provided by the base asset.                                                   |
| `BASE_DISCOUNT_SCALE` | `baseMargin.IMFactor`              | 0.9375 | 0.93  | NA    | 0.9  | \[0.0, .99]  | A scaling of BASE\_DISCOUNT when computing the collateral provided by the base asset for initial margin. |
| `PERP_REQ_MM`         | `PerpMarginRequirements.mmPerpReq` | 0.065  | 0.065 | 0.067 | 0.10 | \[0.0, 1.0]  | The percentage of the spot price per perpetual contract required to be posted for maintenance margin.    |
| `PERP_REQ_IM`         | `PerpMarginRequirements.imPerpReq` | 0.10   | 0.10  | 0.33  | 0.15 | (0.0, 1.0]   | The percentage of the spot price per perpetual contract required to be posted for initial margin.        |
...
| Parameter           | Contract Variable                    | ETH/BTC | SOL  | HYPE | Range        | Description                                                                                                       |
| :------------------ | :----------------------------------- | :------ | :--- | :--- | :----------- | :---------------------------------------------------------------------------------------------------------------- |
| `UNPAIRED_SCALE_IM` | `OptionMarginParams.unpairedIMScale` | 1.2     | 1.25 | 1.3  | \[1.01, 3.0] | A large percentage of the forward price per "naked" short call  per expiry is added to the offset initial margin. |
| `UNPAIRED_SCALE_MM` | `OptionMarginParams.unpairedMMScale` | 1.1     | 1.2  | 1.25 | \[1.01, 3.0] | As above but for maintenance margin.                                                                              |
